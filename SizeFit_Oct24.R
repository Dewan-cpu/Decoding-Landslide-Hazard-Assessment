...
################################################
### Let us explore the covariate information ###
################################################
...
####################################################
### Let us decide the structure of our GAM model ### 
####################################################
num.baseFun = 26
...
##############################################################
### Let us run the GAM model following the structure above ### 
##############################################################
Fit.size = mgcv::gam(Formula.size, family = "gaussian", data = data4fit)

########################################################################
### What is the match between observed and estimated landslide areas ### 
########################################################################
